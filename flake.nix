{
  ...
  outputs = { self, nixpkgs, home-manager, sway-home, nix-flatpak, opencode, nifty-filter, script-wizard, ... }@inputs:
    let
      ...
      availableProfiles = [ "core" "docker" "podman" "nvidia" "pipewire" "python" "rust" "dev" "home-manager" "claude" "open-code" "nifty-services" "step-ca" "woodpecker" "moonshine-nvidia" "sunshine-plasma-nvidia" "samba-mount" "nftables" "semi-mutable" "mutable" ];
